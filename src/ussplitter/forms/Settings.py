...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_server_uri.setObjectName(u"label_server_uri")

        self.horizontalLayout.addWidget(self.label_server_uri)

        self.lineEdit_server_uri = QLineEdit(self.verticalLayoutWidget)
        self.lineEdit_server_uri.setObjectName(u"lineEdit_server_uri")
        ...
        self.label_model_select.setObjectName(u"label_model_select")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_server_uri.setText(QCoreApplication.translate("Dialog", u"Server URI", None))
        self.label_model_select.setText(QCoreApplication.translate("Dialog", u"Model", None))
    # retranslateUi
